...
def init_routes(density):
    init_flow = '  <flow id="i%s" departPos="random_free" from="%s" to="%s" begin="0" end="3600" departLane="%d" departSpeed="0" probability="0.006" type="type1"/>\n'
    init_flow2 = '  <flow id="i%s" departPos="random_free" from="%s" to="%s" begin="0" end="3600" departSpeed="0" probability="0.003" type="type1"/>\n'
    output = ''
